    ...
    <div className="fixed inset-0 z-50" onClick={onClose}>
      ...
      <aside className="absolute right-0 top-0 h-full w-full sm:max-w-lg bg-white shadow-2xl p-6 overflow-y-auto" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="p-3 border border-zinc-200 rounded-xl bg-zinc-50 space-y-4">
            {cloudTripId ? (
              <div className="space-y-2">
                <p className="text-xs font-semibold text-zinc-700">1. Set access</p>
                {isCloudOwnedByCurrentUser ? (
                  <>
                    <select
            ...
            <div className="pt-2 border-t border-zinc-200 space-y-2">
              <p className="text-xs font-semibold text-zinc-700">2. Copy link</p>
              <div className="flex gap-2">
                <input
                  type="text"
                  ...
                  className="flex-1 px-3 py-2 border border-zinc-300 rounded-lg bg-white text-sm font-mono placeholder:font-sans placeholder:text-zinc-500"
                />
                <button
            ...
            {!canCopyShareLink && (
              <div className="p-3 rounded-xl border border-zinc-200 bg-white">
                {!isSupabaseConfigured ? (
                  ...
                  <div className="space-y-2">
                    <p className="text-sm text-zinc-700">Sign in to generate a share link.</p>
                    <button
                      type="button"
                  ...
                  <p className="text-sm text-zinc-700">Preparing share link...</p>
                )}
              </div>
            )}
          </div>
